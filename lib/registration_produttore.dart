...
class RegistrationProduttore extends StatefulWidget {
  const RegistrationProduttore({Key? key}) : super(key: key);

  @override
  State<RegistrationProduttore> createState() => _RegistrationProduttore();
}

class _RegistrationProduttore extends State<RegistrationProduttore> {
